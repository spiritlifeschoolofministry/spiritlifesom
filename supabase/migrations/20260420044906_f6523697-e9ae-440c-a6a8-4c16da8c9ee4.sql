    ...
    PERFORM net.http_post(
      ...
      body := jsonb_build_object(
        ...
        'html', format(
          ...
          '<p><a href="https://spiritlifesom.org/student/dashboard" style="background: #5B2D8E; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">Access Your Dashboard</a></p>' ||
          '<p>God bless you,<br><strong>Spirit Life School of Ministry</strong></p></div>',
