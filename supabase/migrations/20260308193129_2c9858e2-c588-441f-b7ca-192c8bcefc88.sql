    ...
    PERFORM net.http_post(
      ...
      body := jsonb_build_object(
        ...
        'html', format(
          ...
          '<p><a href="https://spiritlifesom.vercel.app/student/dashboard" style="background: #7c3aed; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">Access Your Dashboard</a></p>' ||
